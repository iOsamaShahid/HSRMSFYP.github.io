                    ...
                    <div class="row">
                      ...
                      <div class="row">
                          <div class="input-field col s12">
                            <input id="id" type="text" name="upcat_id" value="<?php echo $row['id']; ?>">
                            <label for="id">ID</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="name" type="text" name="upcat_name" value="<?php echo $row['name'];?>">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              ...
                              <input type="hidden" name="hid" value="<?php echo $row['email']?>">
                            </div>
                          </div>
                           ...
                           <div class="row">
                            <div class="input-field col s12">
                              ...
                              <input type="hidden" name="hid" value="<?php echo $row['contact']?>">
                            </div>
                          </div>
                        </div>
                      </form>
